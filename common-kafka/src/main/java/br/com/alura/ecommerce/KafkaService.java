...
public class KafkaService<T> implements Closeable {
    ...
    void run(){
        while (true) {
            ...
            if (!records.isEmpty()) {
                System.out.println("Register founded: " + records.count());
    ...
    private Properties getProperties(String groupId, Class<T> type, Map<String, String> overrideProperties) {
        ...
        properties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, br.com.alura.ecommerce.gson.GsonDeserializer.class.getName());
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, groupId);
        properties.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, UUID.randomUUID().toString());
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "1");
        properties.setProperty(br.com.alura.ecommerce.gson.GsonDeserializer.TYPE_CONFIG, type.getName());
